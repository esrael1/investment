...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white-500 dark:bg-white-500 dark:text-white">
      {/* Header */}
      <header className="bg-purple-500 dark:bg-gray-800 shadow-sm border-b sticky top-0 z-30">
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-purple-500 dark:bg-gray-900 border-t shadow z-40">
