    ...
    <div className="space-y-6">
      <div className="text-center bg-gradient-to-br from-gray-0 via-gray-900 to-red-0 p-8 rounded-2xl">
        ...
        <p className="mt-3 text-gray-300 text-lg tracking-wide">
          <span className="font-semibold text-indigo-400">Invite friends and earn 15% for each successful referral</span>
        </p>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-md">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• When they purchase their  package, you earn 15 %</li>
